...
_p(ProjectData.AssetRansomMoney);
__p.push('" />元（经手人及联系电话<input type="text" size="23" value="');
_p([ProjectData.AssetRansomCustomerManager,ProjectData.AssetRansomContactPhone].join(' '));
...
__p.push('" />支行，尚欠银行本息约<input type="text" size="5" value="');
_p(ProjectData.AssetRansomMoney);
__p.push('" />元; &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox">已赎楼&nbsp;&nbsp;&nbsp;&nbsp;赎楼金额：<input type="text" size="5" AssetRansomMoney />元<br/><input type="checkbox">已过户&nbsp;&nbsp;&nbsp;&nbsp;过户日期: <input type="text" size="10" />; &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox">已办理抵押&nbsp;&nbsp;&nbsp;&nbsp;抵押日期: <input type="text" size="10" /></td>\n	</tr>\n	<tr>\n		<th>交易情况</th>\n		<td colspan="5">该物业成交价为<input type="text" size="5" value="');
_p(ProjectData.DealMoney);
